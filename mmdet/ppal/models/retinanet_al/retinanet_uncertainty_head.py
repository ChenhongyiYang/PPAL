...
class RetinaHeadUncertainty(RetinaHead):
    def __init__(self, **kwargs):
        super(RetinaHeadUncertainty, self).__init__(**kwargs)
    ...
    def _get_bboxes_single(self,
        ...
        for level_idx, (cls_score, bbox_pred, score_factor, priors) in \
            ...
            results = filter_scores_and_topk(
                scores, 0., cfg.nms_pre,
                dict(bbox_pred=bbox_pred, priors=priors))
            scores, labels, keep_idxs, filtered_results = results

            # scores: [topk,], labels: [topk,], keep_idxs[topk, 2], filtered_results[bbox_pred]
    ...
    def _bbox_post_process(self,
        ...
        if with_nms:
            if mlvl_bboxes.numel() == 0:
                ...
                return det_bboxes, mlvl_labels, torch.zeros_like(mlvl_scores), torch.zeros_like(mlvl_scores)
