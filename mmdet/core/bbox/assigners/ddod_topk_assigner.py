...
class DDODTopkAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        if self.is_atss:
            ...
            overlaps_mean_per_gt = candidate_overlaps.mean(dim=0)
            overlaps_std_per_gt = candidate_overlaps.std(dim=0)
            overlaps_thr_per_gt = overlaps_mean_per_gt + overlaps_std_per_gt
            is_pos = candidate_overlaps > overlaps_thr_per_gt[None, :]
        else:
            _, topk_idxs = overlaps.topk(self.topk, dim=0, largest=True)
